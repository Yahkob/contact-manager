  ...
  db
    ...
    .toArray((error, docs) => {
      if (error) {
        ...
        docs.forEach(doc => {
          contacts.push({id: doc._id, name: doc.name, phone: doc.phone, email: doc.email});
        });
  ...
  db
    ...
    .findOne({
      ...
      if (error) {
        ...
        res
          .status(200)
          .json({id: doc._id, name: doc.name, phone: doc.phone, email: doc.email});
      }
    })
});
